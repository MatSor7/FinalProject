...
def play_trivia_game(questions_answers):
    difficulties = ["Easy", "Normal", "Norwegian"]
    ...
    while True:
        try:
            difficulty_input = input("Your difficulty: ").strip().capitalize()
            if difficulty_input not in difficulties:
                raise ValueError("Invalid difficulty selected.")
            difficulty = difficulty_input
            break
        except ValueError as e:
            print(e)
            print("Please choose a valid difficulty: Easy, Normal, or Norwegian.")
